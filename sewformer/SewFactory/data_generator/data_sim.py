...
pkg_path = os.path.join(root_path, "sewformer", "SewFactory", "packages")
...
def get_command_args():
    ...
    parser.add_argument(
        "--dataname", "-n", help="name of generated", default="sewfactory"
    )
    parser.add_argument(
        "--config",
        "-c",
    ...
    parser.add_argument(
        "--fbx-root", "-f", help="path root of posed fbxs", default="test\\posed_fbxs"
    )
    parser.add_argument(
        "--output",
        "-o",
...
if __name__ == "__main__":
    ...
    logging.basicConfig(
        filename=os.path.join(os.getcwd(), r"playblast_run.txt"),
        filemode="w",
        level=logging.INFO,
